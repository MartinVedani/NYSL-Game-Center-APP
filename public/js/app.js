...
firebase.auth().onAuthStateChanged(function(user) {
    if (user) {
        location.href = "/redirectAfterSignOn.html"; //  if signed In, go to app page = redirectAfterSignOn.html
    }
});
        ...
        'callbacks': {
            ...
            'signInSuccessWithAuthResult': function(authResult, redirectUrl) {
                if (authResult.user) {
                    ...
                    location.href = "/redirectAfterSignOn.html"; // AFTER SIGN ON SUCCESS, go to full page
                }
